    ...
    <div className="fixed right-4 bottom-4 z-50">
      ...
      >
        ...
        >
          ...
          <VisuallyHidden>
            <DialogTitle>Geminex</DialogTitle>
          </VisuallyHidden>
              ...
              {status === "success" ? (
                ...
                >
                  ...
                  <p className="text-muted-foreground text-sm">
                    Your feedback makes Geminex better.
                  </p>
                </motion.div>
              ) : (
                <motion.form
                ...
                >
                  ...
                  >
                    What would make Geminex better for you?
                  </motion.span>
                  <textarea
                  ...
                  />
                  <div className="flex justify-between pt-2 pr-3 pb-3 pl-2">
                    <Button
                      type="button"
                      variant="ghost"
                      size="sm"
